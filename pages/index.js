        ...
        <link rel="icon" href="/favicon.ico" />
          ...
          <header className="flex w-full p-5 justify-between text-sm text-grey-700">
            ...
            <div className='flex space-x-4 items-center'>
              ...
              {/* Avatar */}
              <Avatar url='https://scontent-iad3-2.xx.fbcdn.net/v/t1.18169-9/15894995_1716510618374453_942814852952633069_n.jpg?_nc_cat=100&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=jz5jcCkIhNcAX942cif&_nc_ht=scontent-iad3-2.xx&oh=3f920da1a57d2e1a5f46d0d3b0c117a2&oe=60954F92' />
            </div>
          </header>
